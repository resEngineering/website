...
export default function Footer() {
    return (
        <footer className="flex h-[100px] flex-row w-full items-center justify-center">
            ...
            <div className='flex flex-col sm:flex-row flex-1 w-full h-full items-center justify-evenly '>
                ...
                <a className='w-32 h-10 rounded-lg underline sm:bg-gray-300 text-center content-center' target='_blank' href='https://www.termsfeed.com/live/2a5b3548-ddfa-44bd-9dd3-6738cdf181f0'>Privacy Policy</a>
            </div>
